...
public abstract class ServiceMapper {
  ...
  public ServiceResponse toChildServiceResponse(ChildrenServices services) {
    ...
    return ServiceResponse.builder()
        ...
        .href(services.getHref())
        .image(
            services.getImage() != null
                ? minioService.generateFileUrl(imagesBucket, services.getImage())
                : null)
  ...
  public Pricing toPricing(PricingRequest pricingResponse) {
    return Pricing.builder()
        ...
        .description(
            pricingResponse.getDescription() == null ? null : pricingResponse.getDescription())
  ...
  public SocialResponse toSocialResponse(Social social) {
    return SocialResponse.builder()
        .id(social.getId())
        .color(
            social.getColor() == Color.BLUE_600
                ? "blue-600"
                : social.getColor() == Color.BLUE_700 ? "blue-700" : null)
