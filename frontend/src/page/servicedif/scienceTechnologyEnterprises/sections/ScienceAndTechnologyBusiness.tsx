    ...
    <div className="container mx-auto p-6">
      ...
      <section className="bg-gray-50 rounded-lg shadow-sm p-6">
        ...
        <p className="text-gray-700 text-lg leading-relaxed text-justify">
          Doanh nghiệp khoa học và công nghệ là doanh nghiệp thực hiện sản xuất, kinh doanh, dịch vụ
          khoa học và công nghệ để tạo ra sản phẩm, hàng hoá từ kết quả nghiên cứu khoa học và phát
          triển công nghệ.
        </p>
      </section>
