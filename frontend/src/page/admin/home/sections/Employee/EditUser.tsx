        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-brand-surface rounded-lg">
              <User className="h-6 w-6 text-brand-primaryDark" />
            </div>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-brand-primaryDark focus:border-transparent transition-colors ${
          ...
          <div className="flex gap-4 pt-6 border-t">
            <button
              ...
              disabled={isLoading}
              className="flex-1 flex items-center justify-center gap-2 bg-brand-primary text-white py-3 px-6 rounded-lg hover:bg-brand-primaryDark focus:ring-2 focus:ring-brand-primaryDark focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
