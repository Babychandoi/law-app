...
public class JobController {
  ...
  public ApiResponse<List<JobResponse>> getAllJobs(
      @PageableDefault(size = 12, sort = "postedDate", direction = Sort.Direction.DESC)
          Pageable pageable) {
  ...
  public ResponseEntity<ApiResponse<List<JobResponse>>> searchJobs(
      ...
      @PageableDefault(size = 12, sort = "postedDate", direction = Sort.Direction.DESC)
          Pageable pageable) {
    Page<JobResponse> jobs = jobService.searchJobs(keywords, category, jobType, location, pageable);
  ...
  /** Submit job application with CV upload POST /jobs/apply */
  @PostMapping("/apply")
  ...
  /** Get all applications (admin) GET /jobs/applications */
  ...
  /** Get applications by job ID GET /jobs/{jobId}/applications */
  @GetMapping("/{jobId}/applications")
  public ApiResponse<List<JobApplicationResponse>> getApplicationsByJobId(
