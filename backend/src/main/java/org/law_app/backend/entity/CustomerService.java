...
@Table(
    indexes = {
      @Index(name = "idx_customer_service_service", columnList = "service_id"),
      @Index(name = "idx_customer_service_status", columnList = "status"),
      @Index(name = "idx_customer_service_created_at", columnList = "createdAt")
    })
