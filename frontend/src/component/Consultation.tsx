      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.8fr_1.2fr] lg:gap-16">
        <div className="lg:sticky lg:top-32 lg:self-start">
          ...
          <p className="mt-5 max-w-xl text-base leading-8 text-white/75">
            Điền thông tin để đội ngũ Luật Poip Legal hiểu nhu cầu và chuẩn bị nội dung trao đổi phù
            hợp. Bạn cũng có thể gọi hoặc nhắn Zalo nếu cần phản hồi nhanh.
          </p>
          ...
          <form onSubmit={handleSubmit} noValidate className="grid gap-6">
            ...
            <div className="flex flex-col gap-4 border-t border-brand-line pt-6 sm:flex-row sm:items-center sm:justify-between">
              <p className="max-w-md text-xs leading-5 text-gray-600">
                Bằng việc gửi yêu cầu, bạn đồng ý để Luật Poip Legal liên hệ nhằm hỗ trợ nội dung tư
                vấn đã cung cấp.
              </p>
              <button
                type="submit"
