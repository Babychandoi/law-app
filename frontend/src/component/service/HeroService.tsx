  ...
  return (
    <section className="relative bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white py-24 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden opacity-20">
        ...
        <div
          className="absolute bottom-20 left-20 w-24 h-24 border-2 border-orange-400/30 transform rotate-45 animate-pulse"
          style={{ animationDelay: '0.3s' }}
        ></div>
        <div
          className="absolute top-1/2 right-1/4 w-16 h-16 border-2 border-yellow-400/30 rounded-full animate-pulse"
      ...
      <div className="relative container mx-auto px-6 text-center">
        ...
        {showContactInfo && (phone || email) && (
          <div
            className={`flex flex-col md:flex-row justify-center items-center gap-4 md:gap-6 transition-all duration-1000 delay-700 ${
              isVisible && enableAnimations
                ? 'opacity-100 translate-y-0'
                : 'opacity-0 translate-y-8'
            }`}
