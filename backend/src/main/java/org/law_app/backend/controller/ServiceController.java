...
public class ServiceController {
  ...
  @GetMapping("/{id}")
  public ApiResponse<List<ChildrenServiceResponse>> getChildrenServiceById(
  ...
  @PostMapping("/fee/{id}")
  public ApiResponse<Boolean> createPricingByServiceId(
      @PathVariable String id, @RequestBody List<PricingRequest> pricingRequests) {
