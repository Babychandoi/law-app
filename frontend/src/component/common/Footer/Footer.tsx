...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative text-white overflow-hidden" style={{backgroundColor: '#444444'}}>
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-r from-blue-400/10 to-purple-400/10 rounded-full mix-blend-multiply filter blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-green-400/5 to-teal-400/5 rounded-full mix-blend-multiply filter blur-3xl animate-pulse delay-500"></div>
      </div>
      ...
      <div className="relative z-10 py-12 px-6">
        ...
        <div className="max-w-7xl mx-auto text-center mb-12">
          <div className="relative inline-block">
            ...
            <div className="relative p-6 bg-gray-600/40 rounded-3xl backdrop-blur-xl border border-yellow-400/30 shadow-2xl">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="group">
              ...
              <div className="space-y-4">
                {company?.locations.map((location) => {
                  ...
                  return (
                    <div key={location.id} className={`relative p-6 bg-gray-600/30 rounded-2xl border border-gray-500/50 hover:${colorConfig.border} transition-all duration-500 hover:shadow-2xl hover:${colorConfig.shadow} backdrop-blur-sm group`}>
          ...
          <div className="space-y-8">
            <div className="group">
              ...
              <div className="space-y-4">
                {/* Email */}
                <div className="p-6 bg-gray-600/30 rounded-2xl border border-gray-500/50 hover:border-emerald-400/50 transition-all duration-500 hover:shadow-2xl hover:shadow-emerald-500/20 backdrop-blur-sm group">
                ...
                {/* Phone Numbers */}
                <div className="p-6 bg-gray-600/30 rounded-2xl border border-gray-500/50 hover:border-yellow-400/50 transition-all duration-500 hover:shadow-2xl hover:shadow-yellow-500/20 backdrop-blur-sm">
                  ...
                  <div className="space-y-3">
                    {company?.phoneContacts.map((contact) => {
                      ...
                      return (
                        <div key={contact.id} className="flex items-center justify-between p-3 bg-gray-500/30 rounded-xl hover:bg-gray-500/50 transition-all duration-300 group">
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="p-6 bg-gray-600/30 rounded-2xl border border-gray-500/50 backdrop-blur-sm">
                <div className="space-y-4">
                  <div className="relative group">
                    <input
                      ...
                      className="w-full p-4 pl-12 pr-4 rounded-xl bg-gray-500/30 text-white border border-gray-400/50 focus:outline-none focus:ring-2 focus:ring-pink-400 focus:border-transparent transition-all duration-300 placeholder-gray-400 group-hover:bg-gray-500/50"
                      required
                    />
                ...
                {company?.importants.map((link) => {
                  ...
                  return (
                    <button 
                      ...
                      className={`flex items-center p-3 text-gray-400 ${colorConfig.hover} transition-all duration-300 rounded-lg hover:bg-gray-500/30 group`}
                    >
            ...
            <div className="flex items-center space-x-4">
              ...
              {company?.socials.map((social) => (
                <a
                  ...
                  className={`p-3 bg-gray-600/30 rounded-xl border border-gray-500/50 text-gray-400 hover:text-white hover:bg-${social.color} hover:border-transparent transition-all duration-300 hover:scale-110 hover:shadow-lg transform`}
                >
