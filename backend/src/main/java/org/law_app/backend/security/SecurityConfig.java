...
public class SecurityConfig {
    ...
    private final String[] AuthorizedUrls = new String[] {"/auth/login", "/auth/introspect", "/auth/logout", "/auth/refresh","/customer"};
    private final String[] AuthorizedUrlsPublic = new String[] {"/service/**","/services/**","/jobs/**","/news/**"};
