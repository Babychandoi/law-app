...
public interface ChildrenMapper {
  default ProcessResponse toProcessResponse(Process process, List<ProcessDetail> processDetail) {
    return ProcessResponse.builder()
        ...
        .details(
            processDetail.stream()
                .map(
                    detail ->
                        ProcessDetailResponse.builder()
                            .type(detail.getType())
                            .desc(detail.getDesc())
        ...
        .map(
            detailRequest ->
                ProcessDetail.builder()
                    ...
                    .accuracy(
                        detailRequest.getAccuracy() != null ? detailRequest.getAccuracy() : null)
                    .process(process)
                    .build())
        .toList();
  }
  ...
  default ProcessTimeLine toProcessTimeLine(
      ProcessTimeLineRequest processTimeLineRequest, ChildrenServices services) {
