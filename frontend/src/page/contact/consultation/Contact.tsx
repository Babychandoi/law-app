          ...
          <div >
            <div className="bg-white rounded-lg p-8 shadow-lg">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                ...
                <p className="text-gray-600 leading-relaxed mb-4 last:mb-0">
                  Đối với Luật Poip, khách hàng là trung tâm của mọi hoạt động của chúng tôi. Chúng tôi cam kết mang lại cho khách hàng của mình sự hài lòng và một chất lượng dịch tuyệt vời.
                </p>
            </div>
            {/* Address Section */}
            <div className="bg-white rounded-lg p-8 shadow-lg">
