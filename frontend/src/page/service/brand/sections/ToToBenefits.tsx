...
const ToToBenefits = () => {
  const benefits = [
    ...
    },
    {
      ...
      description: "Sử dụng dịch vụ luật sư tại Luật Poip tăng khả năng đạt tỷ lệ thành công cao trong việc đăng ký bảo hộ nhãn hiệu."
    },
    {
    ...
    },
    {
      ...
      description: "Luật Poip là tổ chức Đại diện SHCN uy tín tại Việt Nam, có đầy đủ năng lực tư vấn và thực thi xác lập quyền SHCN cho khách hàng trong và ngoài nước."
    }
  ];
