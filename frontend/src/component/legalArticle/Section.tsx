    ...
    >
      <div className="p-6">
        <div className="flex items-center gap-4 mb-6">
          <div
            className={`h-12 w-12 bg-gradient-to-br ${gradientColor} rounded-2xl flex items-center justify-center text-white shadow-lg flex-shrink-0`}
          >
            {icon}
          </div>
        ...
        <p className="text-gray-700 leading-relaxed text-justify whitespace-pre-line">{content}</p>
      </div>
    </div>
  );
};
