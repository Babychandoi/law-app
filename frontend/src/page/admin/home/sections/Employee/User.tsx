        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 transition-colors ${
                errors.username
                  ...
                  : 'border-gray-300 focus:ring-brand-primaryDark'
              }`}
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-primaryDark transition-colors"
              disabled={isLoading}
            >
          ...
          <div className="flex justify-end space-x-3 pt-6 border-t">
            ...
            <button
              type="submit"
              className="px-4 py-2 bg-brand-primary text-white rounded-md hover:bg-brand-primaryDark transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
