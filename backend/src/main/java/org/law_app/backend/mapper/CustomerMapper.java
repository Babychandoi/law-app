...
public interface CustomerMapper {
  ...
  default CustomerService toCustomerService(
      CustomerRequest customerRequest, ChildrenServices service) {
  ...
  default CustomerDetailResponse toCustomerDetailResponse(CustomerService customerService) {
    return CustomerDetailResponse.builder()
        ...
        .completedAt(
            customerService.getCompletedAt() != null ? customerService.getCompletedAt() : null)
        .cancelledAt(
            customerService.getCanceledAt() != null ? customerService.getCanceledAt() : null)
        .build();
  }
}
